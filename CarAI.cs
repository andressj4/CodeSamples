...
public class CarAI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            currentTargetPosition = path[index].position;
        }
    }
    ...
    public void SetPath(List<Transform> path)
    {
        ...
        this.path = path;
        index = 0;
        currentTargetPosition = this.path[index].position;

        Vector3 relativepoint = transform.InverseTransformPoint(this.path[index+1].position);
